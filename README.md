...
studies, references, and, in the future, the project's public website.
...
| [`website/`](./website/) | Future public DOFT website |
...
Study 01, Study 02, and Study 05 have now been extracted from their source
repositories and published archives. No valid conclusions are retained from
Study 03 or Study 04, following the author's direction. The next step is to use
the consolidated findings to define the website architecture. Study 06
remains outside the current extraction scope.
